...
class Dog(Animal):
    ...
    def sound(self):
        print("Este animal emite un sonido de Ladrido -Guau!")            
        
class Cat(Animal):
    
    
    def sound(self):
        print("Este animal emite un sonido de Maullido -Miau!")    
...
my_manager =Manager(1,"Antonio")
my_project_manager= ProjectManager(2,"Fernanda","Proyecto 1")    
my_project_manager2= ProjectManager(3,"Kathia","Proyecto 2")
my_programmer=Programmer(4,"Jonathan","Python")    
my_programmer2=Programmer(5,"Lucia","Python")    
my_programmer3=Programmer(6,"Gabriel","JavaScript")    
my_programmer4=Programmer(7,"Marcela","JavaScript")

my_project_manager.add(my_project_manager)    
my_project_manager.add(my_project_manager2)
