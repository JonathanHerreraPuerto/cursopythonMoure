...
data = {
    "name" : "Jonathan",
    "age" : 30,
    "birth_date": "05-11-1993",
    "programming_languages":["Python","JaveScript"]
}

xml_file ="jonathan.xml"
json_file ="jonathan.json"
...
class Data:
    def __init__(self,name, age, birth_date, Programming_languages) ->None:
        ...
        self.programmming_languages=Programming_languages          
